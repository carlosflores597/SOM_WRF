...
'''
datapath = '/study/ecuador/eto_weather_mmap/dates/2017-2021.txt'
outpath = './2017-2021_etovars.npy'
'''

'''
datapath = '/study/ecuador/eto_weather_mmap/dates/full2017.txt'
outpath = './full2017_etovars.npy'
'''
'''
datapath = '/home/agrineer/Desktop/disk_test/dates/full2021.txt'
outpath = './full2021_etovars.npy'
'''
#'''
datapath = './dates/3day.txt'
outpath = './3day.npy'
#'''
...
try:
    if mmap:
        ...
        print( 'collect_data: using memory mapping', file=sys.stderr )
    else:
        eto_vars = np.empty( shape=(sizey*ndays,sizex,sizez), dtype=np.float32 )
        print( 'collect_data: using ram memory', file=sys.stderr )
